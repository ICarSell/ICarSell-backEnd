...
export class AddEntityComments1687787786036 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comments" ("id" SERIAL NOT NULL, "comments" text NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "userId" uuid, "announcementsId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
