...
export class Relation1686779643802 implements MigrationInterface {
    name = 'Relation1686779643802'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcement" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "mark" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "year" integer NOT NULL, "mileage" numeric(12,2) NOT NULL, "color" character varying NOT NULL, "priceFipe" numeric(12,2) NOT NULL, "price" numeric(12,2) NOT NULL, "description" text NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "imgCoverId" uuid, "userId" uuid, CONSTRAINT "REL_5f6ac17aaca9a7a29d8342cdc0" UNIQUE ("imgCoverId"), CONSTRAINT "PK_e0ef0550174fd1099a308fd18a0" PRIMARY KEY ("id"))`);
