...
export class InitialMigration1688404918731 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comments" ("id" SERIAL NOT NULL, "comments" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "announcementsId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_470826bd8eeac6a6252a3891717" FOREIGN KEY ("announcementsId") REFERENCES "announcement"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "announcement" ADD CONSTRAINT "FK_5f6ac17aaca9a7a29d8342cdc08" FOREIGN KEY ("imgCoverId") REFERENCES "imgCover"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_470826bd8eeac6a6252a3891717"`);
