...
export const forgotPasswordService = async (email: string) => {
  try {
    ...
    await transporter.sendMail({
      ...
      <tr>
      <td align="center" style="padding:0;Margin:0;padding-top:15px;padding-bottom:15px"><!--[if mso]><a href="https://motors-shop-mauve.vercel.app/reset-password/${resetToken}" target="_blank" hidden>
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://motors-shop-mauve.vercel.app/reset-password/${resetToken}"
